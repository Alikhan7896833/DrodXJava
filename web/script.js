...
//    // window.location = "user-reset-password.php";
//
//
//    var email = document.getElementById("email2");
//
...
//                window.location = "user-acount.php";
//            } else {
//
...
//                    "return_url": "http://localhost/Furnitican/product-detail.php?id=" + id,     // Important
//                    "cancel_url": "http://localhost/Furnitican/product-detail.php?id=" + id,     // Important
